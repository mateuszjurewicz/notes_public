...
- `lagan` (pron lágyn)
goods thrown into the sea with a buoy attached so that they may be found again. (in legal contexts) goods or wreckage lying on the bed of the sea, but retrievable (unlike derelict). Archaic naval term. 
- `lanyard` (lenjyrd)
...
- `svelte`
slender or graceful in figure or outline; slim. From Italian meaning stretching out.
- `sybarite` / `sybaritic`
